...
public:
    ...
    bool test9() {//Ameena's custom test (my functions were not used a lot in the functions)
        BinarySearchTree bst;
        BinarySearchTree :: TaskItem* test =  new BinarySearchTree::TaskItem(2, "Test Task");
        BinarySearchTree :: TaskItem* test2 =  new BinarySearchTree::TaskItem(7, "Test Task");
        BinarySearchTree :: TaskItem* test3 =  new BinarySearchTree::TaskItem(4, "Test Task");
        BinarySearchTree :: TaskItem* test4 =  new BinarySearchTree::TaskItem(1, "Test Task");
        BinarySearchTree :: TaskItem* test5 =  new BinarySearchTree::TaskItem(5, "Test Task");
//        cout << &test5 <<endl;
//        cout << bst.get_root_node_address() <<endl;
        ASSERT_TRUE(bst.insert(*test2) && bst.insert(*test5));
        //cout << bst.get_node_depth(test);
        ASSERT_TRUE(bst.get_node_depth(test2) == 2);
        
        //cout << bst.min().priority;
        //ASSERT_TRUE(bst.max().priority == 7);
        //ASSERT_TRUE(bst.insert(BinarySearchTree::TaskItem(9, "Test Task")));
        //ASSERT_TRUE(bst.max().priority == 9);
        
        //ASSERT_TRUE(bst.get_node_depth(test))
        return true;
    }
};
#endif
